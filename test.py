...
history = model.fit(X_train, Y_train, validation_data=(X_validation, Y_validation), epochs=epochs, verbose=2, callbacks=[tensorboard_callback])
...
# Save the NN model
model.save(r'{}\model_without_steering_ang_{}.h5'.format(path, num_4_name))
...
plt.savefig(r"{}\training_loss_acc_{}_without_steering_ang".format(path, num_4_name))
# plt.show()


# Save the history dict
hist_df = pd.DataFrame(history.history)
hist_csv_file = r'{}\history_{}_without_steering_ang.csv'.format(path, num_4_name)
